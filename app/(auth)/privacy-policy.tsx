...
export default function PrivacyPolicyScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        <Text className="font-roboto-regular text-sm text-textLight mb-5 italic">
        ...
        <Text className="font-roboto-regular text-base text-textLight leading-7 text-justify mb-2.5">
          Welcome to D&apos;mouv &quot;we&quot;, &quot;our&quot;, &quot;us&quot;). We are committed to
        ...
        <View className="ml-2.5">
          <Text className="font-roboto-regular text-base text-textLight leading-7 mb-1 text-justify">
          ...
          <Text className="font-roboto-regular text-base text-textLight leading-7 mb-1 text-justify">
            • Device and Connection Data: We collect your device&apos;s IP address
            and the SSID of the Wi-Fi network you connect.
          </Text>
        </View>
        ...
        <View className="ml-2.5">
          ...
          <Text className="font-roboto-regular text-base text-textLight leading-7 mb-1 text-justify">
            ...
            access to your device&apos;s camera feed, which is processed for motion
            and not stored unless motion is detected.
          </Text>
          <Text className="font-roboto-regular text-base text-textLight leading-7 mb-1 text-justify">
